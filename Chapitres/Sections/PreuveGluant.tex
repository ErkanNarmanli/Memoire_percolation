\section{Le lemme gluant}
	...
	\subsection{Preuve du lemme gluant}
		...
		\unboldmath
			...
			\begin{equation}\ref{eq:finalGluant:1}
					\Pp{\mathcal{X}\cup\{\#U \geq t\}} 
				\leq \cdot
					\frac{\epsilon}{2}
					\Pp{\relie[B_{3n}\cup B_n']{S_{3n}}{S_n'}}.			
			\end{equation}
			On peut ensuite appliquer la proposition~\ref{prop:Upetit} à~$\epsilon/2$ à~$t$ : il existe un réel~$\delta$ strictement positif tel que 	
