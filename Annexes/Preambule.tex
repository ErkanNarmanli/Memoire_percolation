...
\def\supervisorFirstName{Rafaël}							%Prénom(s) du superviseur
...
%\renewcommand{\thesection}{\Roman{section}.}				%Section
%\renewcommand{\thesubsection}{\arabic{subsection}.}		%Sous-section
...
\newcommand{\SnB}[1][3n]{\overline{S}_{#1}}		%B_{3n} /!\ arg. par défaut : 3n
\newcommand{\Pro}{\bm{\mathrm{P}}}				%Le 'P' de la probabilité
\newcommand{\PpSP}[1][p]{\Pro_{#1}}				%Proba indexée par un paramètre
\newcommand{\Pp}[2][p]{\Pro_{#1}\left(#2\right)}		%Proba ind. par p avec parenthèses
